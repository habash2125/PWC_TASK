...
| `tests/adversarial/test_sql_guard.py`         | 54 hostile statements blocked (incl. PRAGMA, ATTACH,`sqlite_master`, `load_extension`), 9 misplaced-predicate statements repaired (never widened), 17 legitimate ones pass; zero executions without a bound scope |
