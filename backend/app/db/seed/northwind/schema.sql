-- Northwind for SQLite3 — schema only (DDL)
-- Source: https://github.com/jpwhite3/northwind-SQLite3 (MIT, (c) 2016 JP White)
-- This is src/create.sql from that repository with the INSERT statements removed,
-- as recorded in dist/northwind.db (sqlite_master).  Data lives in northwind.db.
